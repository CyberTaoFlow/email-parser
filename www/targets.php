...
<body class="horizontal-menu">
	...
	<section>
		<div class="mainpanel">
				...
				<div class="headerbar-left">
					...
					<div class="topnav">
						...
						<ul class="nav nav-horizontal">
							...
							<li class="active"><a href="#"><i class="fa fa-bullseye"></i><span>Target Database</span></a></li>
			...
			<div class="pageheader">
				<h2><i class="fa fa-database"></i> Targets Table <span>See who's been getting phished!</span></h2>
	...
	<script type="text/javascript">
		...
		function format ( d ) {
			return '<h4>Email Details</h4><pre>' +
